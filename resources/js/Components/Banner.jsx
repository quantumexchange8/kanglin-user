...
const Banner = forwardRef(function Banner({ offsetTop }, ref) {
    return (
        <div
            ...
            className="w-full h-9 flex-col items-start gap-[10px] justify-between bg-linear py-[8px] xl:px-[80px] lg:px-[60px] md:px-[40px] px-[16px] sticky top-[80px] md:top-[92px] z-50 "
        >
